...
from mindspeed_llm.hetermoe.core.transformer.transformer_block import TransformerBlock
from megatron.core.transformer.transformer_config import TransformerConfig
from megatron.core.utils import make_tp_sharded_tensor_for_checkpoint


class HeterExpertGPTModel(LanguageModule):
    ...
    ## 确保​​新版本的代码能够加载旧版本（“老GPT检查点”）保存的模型参数
...
## 将大型输出层的参数切分到多个GPU上，解决显存瓶颈，支持大规模模型并行训练。
## 将解码器从“后归一化”切换为“前归一化”，提升深层网络的训练稳定性。
#     @wraps(fn)
...
## mindspeed-llm对forward的改动为对output的处理，与expert无关