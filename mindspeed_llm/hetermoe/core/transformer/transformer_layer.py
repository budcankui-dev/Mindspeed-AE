...
from hetermoe.core.transformer.moe.moe_layer import HeterMoELayer
...
@dataclass
class HeterExpertTransformerLayerSubmodules:
...
class HeterExpertTransformerLayer(MegatronModule, BaseTransformerLayer):
...
def transformer_layer_init_wrapper(fn):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        if self.mlp.__class__ is MoELayer or HeterMoELayer:
